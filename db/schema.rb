...
ActiveRecord::Schema[7.0].define(version: 2022_07_27_015725) do
  ...
  create_table "quirks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_quirks_on_user_id"
  end

  create_table "tweet_advices", force: :cascade do |t|
    t.string "description"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_tweet_advices_on_user_id"
  end
  ...
  add_foreign_key "tweet_advices", "users"
end
